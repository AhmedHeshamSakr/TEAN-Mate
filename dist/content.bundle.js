...
/***/ "./2-features/HighlightHandler.js":
/*!****************************************!*\
  !*** ./2-features/HighlightHandler.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HighlightHandler)
/* harmony export */ });
...
var HighlightHandler = /*#__PURE__*/function () {
  function HighlightHandler() {
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, HighlightHandler);
    this.highlightBox = null;
  }
  return (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(HighlightHandler, [{
    key: "createHighlightBox",
    value: function createHighlightBox() {
    ...
    value: function highlightElement(section) {
      this.createHighlightBox();
      var rect = section.element.getBoundingClientRect();
      this.highlightBox.style.top = "".concat(rect.top + window.scrollY, "px");
      this.highlightBox.style.left = "".concat(rect.left + window.scrollX, "px");
      this.highlightBox.style.width = "".concat(rect.width, "px");
      this.highlightBox.style.height = "".concat(rect.height, "px");
    ...
    value: function removeHighlightBox() {
      if (this.highlightBox) {
...
var SpeechHandler = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SpeechHandler, [{
    ...
    key: "setHighlightHandler",
    value: function setHighlightHandler(highlightHandler) {
      this.highlightHandler = highlightHandler;
    }
  }, {
    key: "speakCurrentSection",
    value: function speakCurrentSection() {
      var _this$highlightHandle2,
        _this = this;
      if (this.currentIndex >= this.sections.length) {
        var _this$highlightHandle;
        (_this$highlightHandle = this.highlightHandler) === null || _this$highlightHandle === void 0 || _this$highlightHandle.removeHighlightBox();
        return;
      }
      var section = this.sections[this.currentIndex];
      (_this$highlightHandle2 = this.highlightHandler) === null || _this$highlightHandle2 === void 0 || _this$highlightHandle2.highlightElement(section);
      var utterance = new SpeechSynthesisUtterance(section.text);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_url__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/url */ "./node_modules/@babel/runtime-corejs3/core-js-stable/url.js");
...
var TextExtractor = /*#__PURE__*/function () {
  function TextExtractor() {
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, TextExtractor);
  }
  return (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(TextExtractor, null, [{
    ...
    value: function extractAllTextWithTags(node) {
      ...
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        if (tagName === "a" && node.href) {
          var _context2;
          var _text = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_7__(_context2 = node.textContent).call(_context2);
          var domain = new _babel_runtime_corejs3_core_js_stable_url__WEBPACK_IMPORTED_MODULE_8__(node.href).hostname.replace("www.", "");
          if (_text) {
            var _context3;
            textSections.push(_babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_9__(_context3 = "Link text: ".concat(_text, ". Link Destination: ")).call(_context3, domain));
            elementSections.push(node);
          } else {
            textSections.push("Link destination: ".concat(domain));
            elementSections.push(node);
          }
        }
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var _TextExtractor$extrac = TextExtractor.extractAllTextWithTags(child),
              childTexts = _TextExtractor$extrac.textSections,
              childElements = _TextExtractor$extrac.elementSections;
            textSections = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_9__(textSections).call(textSections, childTexts);
            elementSections = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_9__(elementSections).call(elementSections, childElements);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
/* harmony import */ var _2_features_HighlightHandler_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../2-features/HighlightHandler.js */ "./2-features/HighlightHandler.js");
...
/* harmony import */ var _2_features_TextExtractor_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../2-features/TextExtractor.js */ "./2-features/TextExtractor.js");
...
function ensureSidebarExists() {
  var sidebar = document.querySelector('main.sidebar-MainContainer');
  if (!sidebar) {
...
var ContentManager = /*#__PURE__*/function () {
  function ContentManager() {
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ContentManager);
    this.highlightHandler = new _2_features_HighlightHandler_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this.speechHandler = new _2_features_SpeechHandler_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this.setupMessageListener();
  }
  return (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ContentManager, [{
    ...
    key: "handleMessage",
    value: function () {
      var _handleMessage = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_4__.mark(function _callee(request, sender, sendResponse) {
        var sidebar, isVisible;
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_4__.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = _context.t0 === ACTIONS.EXTRACT_TEXT ? 5 : _context.t0 === ACTIONS.SKIP_NEXT ? 9 : _context.t0 === ACTIONS.SKIP_PREVIOUS ? 12 : _context.t0 === ACTIONS.TOGGLE_READING ? 15 : _context.t0 === ACTIONS.ACCESS_LINK ? 18 : _context.t0 === 'toggleSidebar' ? 21 : 26;
              break;
            case 5:
              console.log('Handling text extraction');
              _context.next = 8;
              return this.handleTextExtraction(sendResponse);
            case 8:
            ...
            case 18:
              ...
              return _context.abrupt("break", 28);
            case 21:
              sidebar = ensureSidebarExists();
              isVisible = sidebar.style.display !== 'none';
              ...
              return _context.abrupt("break", 28);
            case 26:
              console.warn("Unknown action: ".concat(request.action));
              sendResponse({
                success: false,
            ...
            case 30:
              ...
              console.error("Error handling request:", _context.t1);
              sendResponse({
                success: false,
    ...
    key: "handleTextExtraction",
    value: function () {
      var _handleTextExtraction = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_4__.mark(function _callee2(sendResponse) {
        var _TextExtractor$extrac, textSections, elementSections, sections;
        return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_4__.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _TextExtractor$extrac = _2_features_TextExtractor_js__WEBPACK_IMPORTED_MODULE_7__["default"].extractAllTextWithTags(document.body), textSections = _TextExtractor$extrac.textSections, elementSections = _TextExtractor$extrac.elementSections;
            ...
            case 5:
              sections = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_3__(textSections).call(textSections, function (text, index) {
                return {
                  text: text,
      ...
      function handleTextExtraction(_x4) {
        return _handleTextExtraction.apply(this, arguments);
      }
      return handleTextExtraction;
    }()
  }, {
    key: "handleSkipToNext",
    value: function handleSkipToNext() {
      if (this.validateSections()) {
        this.speechHandler.skipToNext();
      }
    }
  }, {
    key: "handleSkipToPrevious",
    value: function handleSkipToPrevious() {
      if (this.validateSections()) {
        this.speechHandler.skipToPrevious();
      }
    }
  }, {
    key: "handleToggleReading",
    value: function handleToggleReading() {
    ...
    value: function handleAccessLink() {
      var section = this.speechHandler.sections[this.speechHandler.currentIndex];
      if ((section === null || section === void 0 ? void 0 : section.element.tagName.toLowerCase()) === "a") {
    ...
    value: function validateSections() {
