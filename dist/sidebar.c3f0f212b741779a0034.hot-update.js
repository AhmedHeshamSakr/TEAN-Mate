    ...
    value: function handleSTT() {
      ...
      window.addEventListener("keydown", function (event) {
        if (event.code === "Space" && !_this.artyomAssistant.isListening) {
          ...
          _this.buttonsstt.textContent = "Listening..."; // Change button text
        }
      });
      window.addEventListener("keyup", function (event) {
        if (event.code === "Space" && _this.artyomAssistant.isListening) {
          ...
          stt.textContent = "Speech to Text (STT)"; // Reset button text
        }
      });
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6050a75f767666e6e890")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=sidebar.c3f0f212b741779a0034.hot-update.js.map