    ...
    value: function handleSTT() {
      ...
      window.addEventListener("keydown", function (event) {
        if (event.code === "Space" && !_this.artyomAssistant.isListening) {
          ...
          stt.textContent = "Listening..."; // Change button text
        }
      });
      window.addEventListener("keyup", function (event) {
        if (event.code === "Space" && _this.artyomAssistant.isListening) {
          ...
          sttButton.textContent = "Speech to Text (STT)"; // Reset button text
        }
      });
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("895be493b9a5c8321d0d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=sidebar.60e45b3a3e6f0e1ee4cd.hot-update.js.map