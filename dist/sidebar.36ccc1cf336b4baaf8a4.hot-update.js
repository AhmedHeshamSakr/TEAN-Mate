...
var ArtyomAssistant = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_corejs3_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ArtyomAssistant, [{
    ...
    // Enhanced toggle listening method with error handling and onend listener
  }, {
    key: "toggleListening",
    value: function toggleListening(sidebarController) {
      ...
      if (!this.isListening) {
        ...
        this.artyom.initialize({
          ...
          // Handle unexpected session end
          var nativeApi = _this2.artyom.getNativeApi();
          nativeApi.onend = function () {
            console.warn("Speech recognition session ended unexpectedly.");
            alert("Speech recognition stopped. Restarting...");

            // Restart recognition manually
            _this2.artyom.stop();
            _this2.artyom.startContinuousRecognition().then(function () {
          ...
          console.error("Error initializing Artyom:", err);
          if (err.name === "not-allowed") {
            alert("Microphone access is denied. Please allow microphone permissions in your browser settings.");
          }
        });
      } else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("83d68a167c7287f19b9e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=sidebar.36ccc1cf336b4baaf8a4.hot-update.js.map