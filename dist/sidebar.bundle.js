...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var extractButton = document.getElementById('extractText');
  if (extractButton) {
...
function validateElements(elements) {
  ...
  var missingElements = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_3__(_context = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4__(_context2 = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_5__(elements)).call(_context2, function (_ref) {
    ...
    var _ref4 = (0,_babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_ref3, 1),
      key = _ref4[0];
    return key;
  });
  if (missingElements.length) {
    console.error("Sidebar: Missing elements - ".concat(missingElements.join(', ')));
    return false;
  }
  return true;
}
...
function setupButtonHandlers(elements) {
  var buttons = elements.buttons,
    speechDisplay = elements.speechDisplay;
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_6__(buttons).call(buttons, function (button, index) {
    var action = _babel_runtime_corejs3_core_js_stable_object_values__WEBPACK_IMPORTED_MODULE_7__(ACTIONS)[index];
    if (!action) return;
    button.addEventListener('click', function () {
      return handleButtonClick(button, action, speechDisplay);
    });
  });
}

// Handle individual button clicks
function handleButtonClick(_x, _x2, _x3) {
  return _handleButtonClick.apply(this, arguments);
} // Handle text extraction
function _handleButtonClick() {
  _handleButtonClick = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2__.mark(function _callee(button, action, speechDisplay) {
    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2__.wrap(function _callee$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          button.disabled = true;
          _context3.prev = 1;
          console.log("Button clicked: ".concat(action));
        ...
        case 6:
          ...
          break;
        case 8:
          speechDisplay.textContent = "".concat(action, " is now active");
          console.log("".concat(action, " feature activated"));
        case 10:
          _context3.next = 15;
          break;
        case 12:
          ...
          console.error("Error handling ".concat(action, ":"), _context3.t0);
        case 15:
          _context3.prev = 15;
...
function _handleTextExtraction() {
  _handleTextExtraction = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2__.mark(function _callee2() {
    var _yield$chrome$tabs$qu, _yield$chrome$tabs$qu2, tab, response;
    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2__.wrap(function _callee2$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          _yield$chrome$tabs$qu = _context4.sent;
          _yield$chrome$tabs$qu2 = (0,_babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_yield$chrome$tabs$qu, 1);
        ...
        case 8:
          _context4.next = 10;
          return new _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_8__(function (resolve, reject) {
            chrome.tabs.sendMessage(tab.id, {
              action: ACTIONS.EXTRACT_TEXT
            }, function (response) {
            ...
            _babel_runtime_corejs3_core_js_stable_set_timeout__WEBPACK_IMPORTED_MODULE_9__(function () {
              return reject(new Error('Message send timeout'));
            }, 5000);
          });
        case 10:
        ...
        case 16:
          ...
          console.error('Text extraction error:', _context4.t0);
        case 19:
          ß;
        case 20:
        case "end":
