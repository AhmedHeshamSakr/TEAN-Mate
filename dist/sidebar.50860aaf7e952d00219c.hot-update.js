...
var SidebarController = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_corejs3_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SidebarController, [{
    ...
    value: function handleSTT() {
      ...
      try {
        var isListening = this.voiceAssistant.toggleListening();
        console.log("Voice recognition is now:", isListening ? "ON" : "OFF");
        this.showNotification("Voice recognition ".concat(isListening ? "activated" : "deactivated"));
      } catch (error) {
        console.error("STT Error:", error);
        this.showNotification("An error occurred with STT. Please try again.");
      }
    }
  }, {
    ...
    value: function handleSignLanguage() {
      ...
      this.showNotification("Sign Language Translator activated");
    }
  }, {
    key: "handleImageCaption",
    value: function handleImageCaption() {
      console.log("Image Captioning button clicked");
      this.showNotification("Image Captioning activated");
    }
  }, {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("571f0c4ef0b6dbeebfa8")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=sidebar.50860aaf7e952d00219c.hot-update.js.map