  ...
  return (0,_babel_runtime_corejs3_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ArtyomAssistant, [{
    ...
    value: function setupUI() {
      ...
      startButton.addEventListener("click", function () {
        return _this.toggleListening(startButton);
      });
    }
  }, {
    key: "startListening",
    ...
    key: "toggleListening",
    value: function toggleListening(button) {
      if (this.isListening) {
        this.stopListening();
      } else {
        this.startListening();
...
}(); // Instantiate the assistant when the DOM is fully loaded
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6288e3541035bd7436f4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=sidebar.b4b8fe636782306924a9.hot-update.js.map