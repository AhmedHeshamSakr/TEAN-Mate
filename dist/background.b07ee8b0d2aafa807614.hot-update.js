...
var BackgroundHandler = /*#__PURE__*/function () {
  ...
  return (0,_babel_runtime_corejs3_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(BackgroundHandler, [{
    ...
    value: function setupVoiceCommands() {
      this.voiceAssistant.addCommand("open sidebar", function () {
        chrome.action.onClicked.dispatch(); // Trigger the extension button programmatically
      });
      this.voiceAssistant.addCommand("close sidebar", function () {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5bb763f12d62f80b0062")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=background.b07ee8b0d2aafa807614.hot-update.js.map