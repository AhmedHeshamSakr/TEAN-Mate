function runPredict(inputText, voices, worker) {
	return new Promise((resolve, reject) => {
		...
		// const workerUrl = new URL("../TTSmodel/worker.js", self.location).href;
        ...
        // } catch (error) {
        //     reject(new Error("Worker is not supported in this context"));
        //     return;
        // }
