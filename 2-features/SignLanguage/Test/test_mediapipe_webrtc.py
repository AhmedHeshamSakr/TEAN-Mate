...
# Initialize the holistic model with optimized parameters for sign language
...
async def index(request):
    """Serve the HTML page."""
    with open("holistic_sign_language.html", "r") as f:
        html = f.read()
...
if __name__ == "__main__":
    ...
    # Start server
    print("Starting Holistic Sign Language Detection Server on http://localhost:8080")
